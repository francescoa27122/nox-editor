...
Each heading is an audit finding ID. The entry says how the fix was verified
when a test that fails before and passes after was impractical, and what a
reader should re-check if the surrounding code moves.
